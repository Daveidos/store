	...
	if(isset($_SESSION['user']))
	    {   
	            ...
	            {   
              	...
              	$query="SELECT book_id,Title,Author,Quantity,Price FROM cart INNER JOIN products ON cart.Product=products.book_id 
                                          ...
                                          <div class="panel-body">
			                                                <img class="image-responsive block-center" src="'.$path.'" style="height :100px;"> <br>
                                                                        				...
                                                                        				Code : '.$row['book_id'].'<br>        	 
                                                      									...
                                                      									Price : '.$row['Price'].' <br>
                                                      									Sub Total : '.$Stotal.' <br>
                                                                       <a href="cart.php?remove='.$row['book_id'].'" class="btn btn-sm" 
